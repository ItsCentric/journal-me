<main class="flex h-full justify-center py-4">
	<div class="prose prose-lg">
		<h1>Journal Me Privacy Policy</h1>

		<p>
			At Journal Me, accessible from https://journal.me, one of our main priorities is the privacy
			of our visitors. This Privacy Policy document contains types of information that is collected
			and recorded by Journal Me and how we use it.
		</p>
		...
		<p>
			...
			website with regards to the information that they shared and/or collect in Journal Me. This
		...
		<p>
			Journal Me follows a standard procedure of using log files. These files log visitors when they
		...
		<p>
			Like any other website, Journal Me uses "cookies". These cookies are used to store information
		...
		<p>
			...
			Beacons that are used in their respective advertisements and links that appear on Journal Me,
		...
		<p>
			Note that Journal Me has no access to or control over these cookies that are used by
		...
		<p>
			Journal Me's Privacy Policy does not apply to other advertisers or websites. Thus, we are
		...
		<p>
			Journal Me does not knowingly collect any Personal Identifiable Information from children
